 ...
 * 
 */
public class ECSASource implements RoutingDecisionEngine
{
	/*Initial Temp*/
	...
	public ECSASource(ECSASource lcncp)
	{
		...
		this.rng = new Random();
		/* if you wanna to send just the G msgs in no coding case put deleted 0*/
		this.deleted = K-G;
	...
	public boolean shouldDeleteSentMessage(Message m, DTNHost otherHost)
	{
		...
		/* After sending G msgs start to delete*/
	...
	{
		if(!(otherHost.getRouter().decider instanceof ECSARelay))
			return false;
