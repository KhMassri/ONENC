 ...
 * 
 */
public class ECSADestination implements RoutingDecisionEngine
{
	...
	public ECSADestination(Settings s)
	{
	...
	public ECSADestination(ECSADestination lcncp)
	{
	...
	{
		return new ECSADestination(this);
	}
